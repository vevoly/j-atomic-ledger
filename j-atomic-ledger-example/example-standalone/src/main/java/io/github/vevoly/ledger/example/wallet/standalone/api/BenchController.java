package io.github.vevoly.ledger.example.wallet.standalone.api;
...
import io.github.vevoly.ledger.example.wallet.standalone.component.PerfMonitor;
...
public class BenchController {
    ...
    @Autowired
    private JAtomicLedgerEngine<WalletState, TradeCommand, UserWalletEntity> engine;
